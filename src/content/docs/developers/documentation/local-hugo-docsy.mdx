...
description: How to edit the documentation on the Neurodesk website.
sidebar:
  label: Local Hugo Docsy
  order: 1
---
...
- Hugo **extended** version (0.146.0 recommended). See [https://github.com/gohugoio/hugo/releases](https://github.com/gohugoio/hugo/releases) for Hugo releases.
...
3. Once started, your dev website will be accessible via [http://localhost:1313](http://localhost:1313).
...
2. Verify your Hugo installation:
   ...
   :::caution
   Authorise the binary if macOS blocks it: go to System Settings, Privacy & Security, and allow the app to run.
   :::
...
Once started, your dev website will be accessible via [http://localhost:1313](http://localhost:1313).
