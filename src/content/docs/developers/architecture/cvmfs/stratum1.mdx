---
title: Set up Stratum 1 server
description: Host a Stratum 1 server.
sidebar:
  order: 1
---

The Stratum 1 servers for the desktop are configured here: [https://github.com/neurodesk/neurodesktop/blob/main/Dockerfile](https://github.com/neurodesk/neurodesktop/blob/main/Dockerfile).
...
This setup works best on Rocky Linux 9.
