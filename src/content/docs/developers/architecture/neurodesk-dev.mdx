---
title: Neurodesktop development
description: Testing the latest dev version of Neurodesktop.
sidebar:
  order: 3
---
...
Dev builds can be triggered by Neurodesk admins from [https://github.com/neurodesk/neurodesktop/actions/workflows/build-neurodesktop-dev.yml](https://github.com/neurodesk/neurodesktop/actions/workflows/build-neurodesktop-dev.yml).
