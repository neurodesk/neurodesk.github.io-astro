---
title: CVMFS
description: Mount Neurodesk Singularity containers from CVMFS.
sidebar:
  order: 3
---
...
To begin, install CVMFS. Follow the [official quickstart](https://cvmfs.readthedocs.io/en/stable/cpt-quickstart.html#getting-the-software).
...
- New York, USA: `s1bnl-cvmfs.openhtc.io:8080` → `cvmfs-s1bnl.opensciencegrid.org:8000`
...
- Indiana, USA: `cvmfs-jetstream.neurodesk.org` → `149.165.172.188`
...
## Use containers in the module system
