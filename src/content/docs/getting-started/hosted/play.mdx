...
:::note
Neurodesk Play is free but comes with resource limits. For more intensive workloads, consider [installing Neurodesk locally](/getting-started/local/) or using one of our [other hosting options](/getting-started/hosted/).
:::
...
[View Data Transfer Documentation →](/getting-started/neurodesktop/storage)
