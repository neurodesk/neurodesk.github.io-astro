...
description: How to cite Neurodesk and the tools used through the platform.
sidebar:
...
If you used Neurodesk in your research or teaching, please cite our main paper and the relevant containerised tools to ensure reproducibility and proper attribution.
...
If you used **Neurodesktop**, please include the version used (e.g. `v{jupyterNeurodeskVersion}`). See [examples below](#examples).
...
For reproducibility, please include the **tool name**, **version number**, and **build date** for any containerised application used in Neurodesk. This information is available in our [application list](/overview/applications/).
...
:::note[Citing EEG/MEG related tools]
If you used any EEG/MEG/electrophysiology tools, please also cite the AEDAPT project.
:::

## Examples

Here are some example excerpts of how to cite Neurodesk:

"TGV QSM (v1.0.0_20210629, Langkammer et al, 2015) was run in Neurodesk (v{jupyterNeurodeskVersion}, Renton et al, 2022)"

**EEG example:** "EEGlab (2020.0_20211026, Delorme & Makeig, 2004) was run in Neurodesk (v{jupyterNeurodeskVersion}, Renton et al, 2022) part of the AEDAPT project."
