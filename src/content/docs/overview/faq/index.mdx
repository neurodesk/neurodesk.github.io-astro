...
<div class="collapse-toolbar not-content">
  <button type="button" class="collapse-toolbar__btn" data-expand="all" data-target=".faq-item">Expand all</button>
  <button type="button" class="collapse-toolbar__btn" data-expand="none" data-target=".faq-item">Collapse all</button>
</div>
